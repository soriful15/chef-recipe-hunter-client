        ...
        <div className='py-14 mt-20'>
            ...
            <footer className="footer p-10 bg-cyan-200 text-base-content">
                <div>
                    ...
                    <a className="link link-hover">Baked Goods</a>
                    <a className="link link-hover">Fish Recipe</a>
                    <a className="link link-hover">Main Dishes</a>
                    <a className="link link-hover">Meat Recipes</a>
                    <a className="link link-hover">Video Recipe</a>
                </div>
                <div>
                    <span className="footer-title">Popular Topics</span>
                    <a className="link link-hover">5 Minutes Recipe</a>
                    <a className="link link-hover">Avocado salad</a>
                    <a className="link link-hover">Bhat And Bhat Recipe</a>
                    <a className="link link-hover">Baked fish in a light yogurt sauce Recipe</a>
                    <a className="link link-hover">Fish Recipe</a>
                    <a className="link link-hover">Spicy Dry Chicken – Kosha Murgir Mangsho Recipe</a>
                    <a className="link link-hover">Meat Recipe </a>
                </div>
                <div>
            ...
            <footer className="footer px-10 py-4 border-t bg-orange-200 text-base-content border-base-300">
                <div className="items-center grid-flow-col">
                    ...
                    <p> Hearing. Of and the maybe her princesses her <br />   back pushed help you other or it’s of synthesizers.</p>
                </div>
