...
const BakedRecipes = () => {
    return (
        <div className='grid lg:grid-cols-3  md:grid-cols-2   mx-auto container gap-5 mt-8 '>
            ...
            <img src={breakfast} alt="Shoes" className="rounded-xl h-48 w-full" />
                </figure>
            ...
            <div className="card w-96 bg-base-300 shadow-xl">
                <figure className="px-10 pt-10">
                 <img src={lunchFood} alt="Shoes" className="rounded-xl h-48 w-full" />
                </figure>
                <div className="card-body items-center text-center">
                    <h2 className="card-title">Lunch Food</h2>
                   
                    <div className="card-actions">
                        <button className="btn btn-primary  ">36 Recipes</button>
                    </div>
                </div>
            </div>
            ...
            <div className="card w-96 bg-base-300 shadow-xl">
                <figure className="px-10 pt-10">
                <img src={DinnerFood} alt="Shoes" className="rounded-xl h-48 w-full" />
                </figure>
                <div className="card-body items-center text-center">
                    <h2 className="card-title">Dinner Food</h2>
                   
                    <div className="card-actions">
                        <button className="btn btn-primary">40 Recipes</button>
                    </div>
                </div>
            </div>
        </div>
