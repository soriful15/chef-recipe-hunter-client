        ...
        <>
            ...
            <div className='grid lg:grid-cols-3  md:grid-cols-2 gap-4 mx-auto container mt-10'>
                ...
                <div className="card w-96 bg-base-100 shadow-xl">
                    <figure><img src={specialRecipe1} className='w-full' alt="Shoes" /></figure>
                ...
                <div className="card w-96 bg-base-100 shadow-xl">
                    <figure><img src={specialRecipe2} className='w-full' alt="Shoes" /></figure>
                    <div className="card-body">
                        <h2 className="card-title text-blue-600 ">
                ...
                <div className="card w-96 bg-base-100 shadow-xl">
                    <figure><img src={specialRecipe3} className='w-full' alt="Shoes" /></figure>
                    <div className="card-body">
                        <h2 className="card-title text-blue-600 ">
                            Shahi Rezala
                            <div className="badge badge-secondary">NEW</div>
                ...
                <div className="card w-96 bg-base-100 shadow-xl">
                    <figure><img src={specialRecipe4} className='w-full' alt="Shoes" /></figure>
                    <div className="card-body">
                        <h2 className="card-title text-blue-600 ">
                            Fish Korma
                            <div className="badge badge-secondary">NEW</div>
                ...
                <div className="card w-96 bg-base-100 shadow-xl">
                    <figure><img src={specialRecipe5} className='w-full' alt="Shoes" /></figure>
                    <div className="card-body">
                        <h2 className="card-title text-blue-600 ">
                        Beef Vindaloo
                            <div className="badge badge-secondary">NEW</div>
                ...
                <div className="card w-96 bg-base-100 shadow-xl">
                    <figure><img src={specialRecipe6} className='w-full' alt="Shoes" /></figure>
                    <div className="card-body">
                        <h2 className="card-title text-blue-600 ">
